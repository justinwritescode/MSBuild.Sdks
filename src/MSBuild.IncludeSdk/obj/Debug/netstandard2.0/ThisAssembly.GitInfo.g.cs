...
namespace 
{
  ...
  partial class ThisAssembly
  {
    ...
    public partial class Git
    {
      ...
      /// <summary>Repository URL: https://github.com/justinwritescode/Build.Include.Sdk.git</summary>
      public const string RepositoryUrl = @"https://github.com/justinwritescode/Build.Include.Sdk.git";

      /// <summary>Branch: main</summary>
      public const string Branch = @"main";

      /// <summary>Commit: dbb8ffc</summary>
      public const string Commit = @"dbb8ffc";

      /// <summary>Sha: dbb8ffccaf1c8329d277ee7d7d70efe73b1e8a5f</summary>
      public const string Sha = @"dbb8ffccaf1c8329d277ee7d7d70efe73b1e8a5f";

      /// <summary>Commit date: 2022-10-07T18:28:28-04:00</summary>
      public const string CommitDate = @"2022-10-07T18:28:28-04:00";

      /// <summary>Commits on top of base version: 0</summary>
      public const string Commits = @"0";

      /// <summary>Tag: v0.0.1</summary>
      public const string Tag = @"v0.0.1";
