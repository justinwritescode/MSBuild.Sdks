    ...
    public override bool Execute()
    {
        ...
        var usingsProjectFile = new XDocument(
            ...
            new XElement(
                ...
                new XElement(
                    "ItemGroup",
                    packageReferenceTuples.Select(x => FormatReference(x, "PackageReference", true)).Concat(DefaultPackageReferences).Distinct()),
                new XElement(
                    "ItemGroup",
                    new XElement(
                        "Content",
                        new XAttribute("Include", "README.md"),
                        new XAttribute("Pack", "true"),
                        new XAttribute("PackagePath", "README.md")),
                    new XElement(
                        "Content",
